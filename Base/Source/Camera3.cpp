...
static float m_fTPVCameraOffset = 75.f;
...
void Camera3::UpdatePosition(Vector3 pos, Vector3 dir)
{
	position = pos - dir.Normalized() * m_fTPVCameraOffset;
	target = pos;
}
...
void Camera3::UpdateJump(const double dt)
{
 ...
 void Camera3::Zoom(const double dt)
 {
	 m_fTPVCameraOffset += dt;
 }
